-- V50__Bind_Tecnicos_To_Supervisores.sql
-- Associa os tecnicos aos seus supervisores utilizando dados da planilha
...
BEGIN
    ...
    SELECT id_supervisor INTO v_id_sup FROM tb_supervisor WHERE UPPER(TRIM(nome_completo)) = UPPER('Adriano Luiz Cherubini Pompeo') LIMIT 1;
